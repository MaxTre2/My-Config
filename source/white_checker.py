...
ИСПРАВЛЕНИЯ: 
- Защита от зомби-процессов, точные WHITE-домены, таймауты
- ИСПРАВЛЕНО: WHITE_THRESHOLD снижен до 1 (иначе хорошие заграничные конфигы летели в BLACK)
- ИСПРАВЛЕНО: HTTP_TIMEOUT увеличен для стабильности
"""
...
# ИСПРАВЛЕНИЕ: Достаточно открыть 1 сайт из РФ, чтобы попасть в WHITE
# Зарубежные VPN через XHTTP часто не тянут 2 тяжелых банка из-за таймаутов РКН
WHITE_THRESHOLD = 1  

HTTP_TIMEOUT = 10  # ИСПРАВЛЕНИЕ: Увеличено с 8 до 10 для уверенности
