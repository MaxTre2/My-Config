...
# Якорные домены РФ белого списка
...
# Путь к бинарнику xray (сначала в корне репозитория, потом рядом со скриптом)
def _find_xray():
    # Ищем в корне репозитория (../xray)
...
def _stream_settings(params: dict, net: str, security: str, host: str) -> dict:
    """Универсальный строитель streamSettings."""
