...
Адаптировано для работы в GitHub Actions
ИСПРАВЛЕНИЯ: 
- Защита от зомби-процессов, точные WHITE-домены, таймауты
- WHITE_THRESHOLD = 1 
- ИСПРАВЛЕНО: Домены сменены с банков на публичные сервисы (Яндекс, ВК, Почта)
  так как банки блокируют IP-адреса серверов GitHub Actions (США)
"""
...
# ИСПРАВЛЕНИЕ ИЗ ЛОГА: Банки блокируют облако GitHub. Меняем на открытые сервисы РФ.
WHITE_TEST_DOMAINS = [
    "yandex.ru",
    "vk.com",
    "mail.ru",
