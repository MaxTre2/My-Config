...
- Сбор из 50+ источников (включая REALITY)
...
MAX_KEYS_TO_CHECK = 8000        # Увеличено для REALITY
...
URLS = [
    ...
    # === ДОПОЛНИТЕЛЬНЫЕ REALITY + gRPC ИСТОЧНИКИ (СТАБИЛЬНЫЕ) ===
...
def main(dry_run=False):
    print("=" * 60)
    print("  🚀 MAIN.PY ОПТИМИЗИРОВАННАЯ ВЕРСИЯ (с REALITY)")
    print("=" * 60)
