...
- Оптимизированные таймауты и обработка ошибок
"""
...
# =============================================================================
# TCP/TLS/WS ПРОВЕРКА (с улучшенной обработкой ошибок)
# =============================================================================
...
def check_single_key(key: str):
    try:
        ...
        # Ошибки соединения — просто пропускаем
        return None, None, None, None
    except Exception:
        return None, None, None, None
