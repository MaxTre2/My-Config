"""
main.py — АБСОЛЮТНО ЧЕСТНАЯ ВЕРСИЯ
...
- ИСПРАВЛЕНО: В FAST-файлы попадают ТОЛЬКО конфиги, проверенные реальным трафиком Xray
...
- WHITE/BLACK сплит адаптирован под GitHub Actions (без банковских доменов)
"""
...
def xray_fast_check(keys: list, limit: int = 300) -> list:
    ...
    # ИСПРАВЛЕНИЕ ИЗ ЛОГА: Возвращаем ТОЛЬКО проверенные. Непроверенный мусор отсекается.
...
def main(dry_run=False):
    print("=" * 60)
    print("  🚀 MAIN.PY АБСОЛЮТНО ЧЕСТНАЯ ВЕРСИЯ (REALITY + XHTTP + XTLS Vision)")
    print("=" * 60)
