...
MAX_KEYS_TO_CHECK = 8000       # Уменьшено с 30000 для скорости
TIMEOUT = 8                     # Таймаут 8 секунд
THREADS = 20                    # 20 потоков одновременно
MAX_PING_MS = 3000              # Максимальный пинг 3 секунды
FAST_LIMIT = 2000               # Топ-2000 быстрых ключей
CHUNK_LIMIT = 1000              # Размер чанка для файлов
EURO_CHUNK_LIMIT = 500          
CACHE_HOURS = 6                 
MAX_HISTORY_AGE = 2 * 24 * 3600
MAX_WHITE_TEST = 200            # Сколько ключей проверять на белизну

# =============================================================================
# ПРОВЕРКА ОКРУЖЕНИЯ (таймаут и xray)
# =============================================================================
...
# =============================================================================
# ИСТОЧНИКИ (сокращенные до рабочих)
# =============================================================================
    ...
    try:
        ...
        if is_ws:
            ...
            ws = websocket.create_connection(
                ...
                sockopt=((socket.SOL_SOCKET, socket.SO_RCVTIMEO, 5),),
            )
            ws.close()
        elif is_tls:
